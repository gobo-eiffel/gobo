...
* Added command-line option `--library` to specify the names of libraries
  ...
  to specify several library names.
* Updated output of format `html_ise_stylesheet` to match the

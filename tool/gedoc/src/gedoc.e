...
feature -- Argument parsing
	...
	parse_arguments (a_args: ARRAY [STRING])
		...
		do
			...
			format_option.extend ("attr_rename")
			...
			format_option.set_parameter_description ("pretty_print|html_ise_stylesheet|descendants|attr_rename|implicit_converts|explicit_converts|ecf_pretty_print|available_targets")
			...
			elseif format_option.parameter ~ "attr_rename" then
				create {GEDOC_ATTR_RENAME_FORMAT} l_format.make (l_input_filename, new_system_processor (thread_option))

...
In this test, we have a call `b.standard_copy (10)` where `b` is an attribute of basic expanded type `INTEGER`. The call to `standard_copy` sets the value of the object attached to this attribute, not of a clone. This test satisfies `MUGC-2`.

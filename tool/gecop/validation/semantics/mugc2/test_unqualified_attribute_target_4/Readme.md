...
In this test, we have a call `b.set_item (10)` where `b` is an attribute of basic expanded type `INTEGER`. The call to `set_item` sets the value of the object attached to this attribute, not of a clone. This test satisfies `MUGC-2`.

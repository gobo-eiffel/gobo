...
* ISE Eiffel (as of 20.05.10.4440 and after) does not clone the object with copy semantics in *finalized mode*. This violates `MBRE-3`. It works as expected in *workbench mode*.

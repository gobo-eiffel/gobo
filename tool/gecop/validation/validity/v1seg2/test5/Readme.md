...
In this test, there is a separate instruction with an argument whose name `x` is also the name of a local variable of an enclosing inline agent. This violates `V1SE-G2`.

...
In this test, `Result` of attached type is not initialized in one
of the branches of the conditional instruction, and hence at the
end of the body of the attribute `f`. This violates `VEVI`.

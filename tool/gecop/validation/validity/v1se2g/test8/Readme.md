...
In this test, there is a separate instruction with an argument `x` which appears in another enclosing separate instruction with an argument of the same name. This violates `V1SE-2G`.

...
In this test, there is a separate instruction with an argument whose name `x` is also the name of an argument of the enclosing feature. This violates `V1SE-2G`.

...
In this test, there is a separate instruction with an argument whose name `x` is also the name of a local variable of the enclosing feature. This violates `V1SE-2G`.

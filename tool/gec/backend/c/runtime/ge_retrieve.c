...
#define GE_STORABLE_READ_BUFFER_SIZE 262144L

/* Struct for Storable read buffer. */
typedef struct GE_storable_read_buffer_struct GE_storable_read_buffer;
struct GE_storable_read_buffer_struct {
	...
	int (*read_char)(GE_storable_read_buffer*, char *, int); /* Function to fill in the buffer. */
};
...
typedef struct {
	...
	int (*read_char)(GE_storable_read_buffer*, char *, int); /* Function to fill in the buffer. */
	int file_desc;
} GE_storable_read_buffer_from_file;
 ...
 */
static int GE_storable_read(GE_storable_read_buffer* a_buffer, char* a_pointer, int a_size)
{
	return read(((GE_storable_read_buffer_from_file*)a_buffer)->file_desc, a_pointer, a_size);
}

/*
 * Create a new buffer to read Stored objects.
 */
static GE_storable_read_buffer* GE_new_storable_read_buffer(int (*read_char)(GE_storable_read_buffer*, char *, int))
{
	GE_storable_read_buffer* buffer;

	buffer = (GE_storable_read_buffer*)GE_malloc(sizeof(GE_storable_read_buffer));
	buffer->position = 0;
	buffer->count = 0;
	buffer->capacity = GE_STORABLE_READ_BUFFER_SIZE;
 ...
 */
static GE_storable_read_buffer* GE_new_storable_read_buffer_from_file(int (*read_char)(GE_storable_read_buffer*, char *, int), int a_file_desc)
{
	GE_storable_read_buffer_from_file* buffer;

	buffer = (GE_storable_read_buffer_from_file*)GE_malloc(sizeof(GE_storable_read_buffer_from_file));
	buffer->position = 0;
	buffer->count = 0;
	buffer->capacity = GE_STORABLE_READ_BUFFER_SIZE;
	buffer->bytes = (char*)GE_malloc_atomic(buffer->capacity);
	...
	return (GE_storable_read_buffer*)buffer;
}

/*
 * Fill `a_buffer'.
 */
static void GE_storable_fill_read_buffer(GE_storable_read_buffer* a_buffer)
{
	int32_t l_size;
	int l_bytes_read;
	long l_amount_left;
 ...
 */
static void GE_storable_check_read_buffer_capacity(GE_storable_read_buffer* a_buffer, size_t a_size)
{
	if ((a_buffer->position + a_size) > a_buffer->count) {
		GE_storable_fill_read_buffer(a_buffer);
	}
}
 ...
 */
static void GE_storable_read_character_8(GE_storable_read_buffer* a_buffer, EIF_CHARACTER_8* a_object, size_t a_num)
{
	size_t i = 0;
	EIF_CHARACTER_8 l_value;

	while (a_num > i++) {
		GE_storable_check_read_buffer_capacity(a_buffer, sizeof(EIF_CHARACTER_8));
 ...
 */
static void GE_storable_read_boolean(GE_storable_read_buffer* a_buffer, EIF_BOOLEAN* a_object, size_t a_num)
{
	size_t i = 0;
	char l_value;
	...
	while (a_num > i++) {
		GE_storable_check_read_buffer_capacity(a_buffer, sizeof(char));
 ...
 */
static void GE_storable_read_integer_8(GE_storable_read_buffer* a_buffer, EIF_INTEGER_8* a_object, size_t a_num)
{
	size_t i = 0;
	EIF_INTEGER_8 l_value;

	while (a_num > i++) {
		GE_storable_check_read_buffer_capacity(a_buffer, sizeof(EIF_INTEGER_8));
 ...
 */
static void GE_storable_read_natural_8(GE_storable_read_buffer* a_buffer, EIF_NATURAL_8* a_object, size_t a_num)
{
	GE_storable_read_integer_8(a_buffer, (EIF_INTEGER_8*)a_object, a_num);
}

/*
 * Read `a_num' INTEGER_16 values from `a_buffer' and make them available in `a_object'.
 */
static void GE_storable_read_integer_16(GE_storable_read_buffer* a_buffer, EIF_INTEGER_16* a_object, size_t a_num)
{
	size_t i = 0;
	EIF_INTEGER_16 l_value;

	while (a_num > i++) {
		GE_storable_check_read_buffer_capacity(a_buffer, sizeof(EIF_INTEGER_16));
 ...
 */
static void GE_storable_read_natural_16(GE_storable_read_buffer* a_buffer, EIF_NATURAL_16* a_object, size_t a_num)
{
	GE_storable_read_integer_16(a_buffer, (EIF_INTEGER_16*)a_object, a_num);
}

/*
 * Read `a_num' INTEGER_32 values from `a_buffer' and make them available in `a_object'.
 */
static void GE_storable_read_integer_32(GE_storable_read_buffer* a_buffer, EIF_INTEGER_32* a_object, size_t a_num)
{
	size_t i = 0;
	EIF_INTEGER_32 l_value;

	while (a_num > i++) {
		GE_storable_check_read_buffer_capacity(a_buffer, sizeof(EIF_INTEGER_32));
 ...
 */
static void GE_storable_read_natural_32(GE_storable_read_buffer* a_buffer, EIF_NATURAL_32* a_object, size_t a_num)
{
	GE_storable_read_integer_32(a_buffer, (EIF_INTEGER_32*)a_object, a_num);
}

/*
 * Read `a_num' INTEGER_64 values from `a_buffer' and make them available in `a_object'.
 */
static void GE_storable_read_integer_64(GE_storable_read_buffer* a_buffer, EIF_INTEGER_64* a_object, size_t a_num)
{
	size_t i = 0;
	...
	while (a_num > i++) {
		GE_storable_check_read_buffer_capacity(a_buffer, sizeof(EIF_INTEGER_64));
 ...
 */
static void GE_storable_read_natural_64(GE_storable_read_buffer* a_buffer, EIF_NATURAL_64* a_object, size_t a_num)
{
	GE_storable_read_integer_64(a_buffer, (EIF_INTEGER_64*)a_object, a_num);
}

/*
 * Read `a_num' CHARACTER_32 values from `a_buffer' and make them available in `a_object'.
 */
static void GE_storable_read_character_32(GE_storable_read_buffer* a_buffer, EIF_CHARACTER_32* a_object, size_t a_num)
{
	GE_storable_read_integer_32(a_buffer, (EIF_INTEGER_32*)a_object, a_num);
}
 ...
 */
static void GE_storable_read_real_64(GE_storable_read_buffer* a_buffer, EIF_REAL_64* a_object, size_t a_num)
{
	size_t i = 0;
	EIF_REAL_64 l_value;
	...
	while (a_num > i++) {
		GE_storable_check_read_buffer_capacity(a_buffer, sizeof(EIF_REAL_64));
 ...
 */
static void GE_storable_read_real_32(GE_storable_read_buffer* a_buffer, EIF_REAL_32* a_object, size_t a_num)
{
	size_t i = 0;
	EIF_REAL_64 l_value;
	...
	while (a_num > i++) {
		GE_storable_read_real_64(a_buffer, &l_value, 1);
 ...
 */
static void GE_storable_read_pointer_with_size(GE_storable_read_buffer* a_buffer, uint64_t* a_object, size_t a_num, int8_t a_size)
{
	...
	case 4:
		while (a_num > i++) {
			GE_storable_read_natural_32(a_buffer, &l_pointer_32, 1);
			*a_object++ = (uint64_t)l_pointer_32;
		}
		break;
	case 8:
		GE_storable_read_natural_64(a_buffer, a_object, a_num);
		break;
	default:
 ...
 * Read `a_num' pointer values from `a_buffer' and make them available in `a_object'.
 */
static void GE_storable_read_pointer(GE_storable_read_buffer* a_buffer, uint64_t* a_object, size_t a_num)
{
	int8_t nb;

	/* First we get the number of bytes used to store a pointer value. */
	GE_storable_read_integer_8(a_buffer, &nb, 1);
	GE_storable_read_pointer_with_size(a_buffer, a_object, a_num, nb);
}
	
/*
 * Free memory allocated by `a_buffer'.
 */
static void GE_free_storable_read_buffer(GE_storable_read_buffer* a_buffer)
{
...
struct GE_storable_unresolved_address_struct {
	...
	GE_storable_unresolved_address* next;
};
...
typedef struct {
	...
	GE_storable_unresolved_address* unresolved_address; /* Addresses not resolved yet. */
} GE_storable_object;
...
typedef struct {
	...
	GE_storable_class** classes; /* Classes in schema. */
	int32_t object_count; /* Number of objects.*/
	GE_storable_object* objects; /* Objects. */
} GE_storable_data;

/*
 * New unresolved address.
 */
static GE_storable_unresolved_address* GE_new_storable_unresolved_address(uint64_t a_old_address, EIF_REFERENCE a_object, uint32_t a_physical_offset, char* a_class_name, GE_attribute* a_attribute, uint32_t a_special_index)
{
	GE_storable_unresolved_address* l_unresolved_address;

	l_unresolved_address = (GE_storable_unresolved_address*)GE_malloc(sizeof(GE_storable_unresolved_address));
 ...
 */
static void GE_free_storable_data(GE_storable_data* a_data)
{
	int16_t i;
	int16_t j;
	int32_t k;
	GE_storable_class* l_class;
	GE_storable_attribute* l_attribute;
	int32_t l_object_count;
	GE_storable_object* l_objects;
	GE_storable_object* l_object;
	GE_storable_unresolved_address* l_address;
...
static EIF_REFERENCE GE_storable_retrieved_with_format(GE_storable_read_buffer* a_buffer, int8_t a_storable_format);
static void GE_storable_read_classes(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data);
static void GE_storable_read_class(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_class* a_class);
static void GE_storable_read_attribute(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_class* a_class, GE_storable_attribute* a_attribute);
static void GE_storable_read_objects(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data);
static void GE_storable_read_object(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object);
static void GE_storable_read_subobject(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object);
static void GE_storable_read_tuple_subobject(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object);
static void GE_storable_read_special_subobject(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object);
static void GE_storable_read_regular_subobject(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object);
static void GE_storable_read_object_type(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object);
static void GE_storable_resolve_object_type(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object, int32_t** volatile a_types_ptr, char** volatile a_type_name_ptr);
static EIF_TYPE_INDEX GE_storable_type_id_from_name(char* a_name);
static int GE_storable_resolve_address(GE_storable_data* a_data, GE_storable_object* a_object, GE_storable_unresolved_address* a_address);
static void GE_storable_resolve_all_addresses(GE_storable_data* a_data);
...
static EIF_REFERENCE GE_storable_retrieved_with_format(GE_storable_read_buffer* a_buffer, int8_t a_storable_format)
{
	GE_storable_data* l_data;
	EIF_REFERENCE l_object;
	char l_error_message[101];

	l_data = (GE_storable_data*)GE_calloc(1, sizeof(GE_storable_data));
	l_data->storable_format = a_storable_format;
	a_buffer->read_char(a_buffer, &(l_data->storable_properties), 1);
	GE_storable_read_integer_16(a_buffer, &(l_data->overhead_size), 1);
	GE_storable_read_integer_16(a_buffer, &(l_data->maximum_class_index), 1);
	...
	l_data->classes = (GE_storable_class**)GE_calloc(l_data->maximum_class_index + 1, sizeof(GE_storable_class*));
	GE_storable_read_integer_16(a_buffer, &(l_data->class_count), 1);
	...
	GE_storable_read_classes(a_buffer, l_data);
	GE_storable_read_objects(a_buffer, l_data);
	/* The root object is the last in the list. */
	l_object = l_data->objects[l_data-> object_count - 1].object;
	GE_free_storable_data(l_data);
...
static void GE_storable_read_classes(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data)
{
	...
	for(i = 0; i < a_data->class_count; i++) {
		l_class = (GE_storable_class*)GE_calloc(1, sizeof(GE_storable_class));
		GE_storable_read_class(a_buffer, a_data, l_class);
...
static void GE_storable_read_class(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_class* a_class)
{
	...
	a_class->name = l_name;
	GE_storable_read_character_8(a_buffer, (EIF_CHARACTER_8*)l_name, nb);
	l_name[nb] = '\0';
	GE_storable_read_natural_32(a_buffer, &(a_class->flags), 1);
	GE_storable_read_integer_16(a_buffer, &(a_class->index), 1);
	if (a_class->index < 0) {
		GE_free(l_name);
		GE_free(a_class);
	...
	GE_storable_read_natural_32(a_buffer, &nb2, 1);
	if (nb2 < 0) {
		...
		GE_storable_read_character_8(a_buffer, (EIF_CHARACTER_8*)l_name, nb2);
		l_name[nb2] = '\0';
	}
	/* Read formal generic parameters. */
	GE_storable_read_integer_16(a_buffer, &(a_class->formal_parameter_count), 1);
	if (a_class->formal_parameter_count < 0) {
		...
		GE_storable_read_natural_32(a_buffer, a_class->formal_parameters, a_class->formal_parameter_count);
	}
	/* Read attributes. */
	GE_storable_read_integer_16(a_buffer, &(a_class->attribute_count), 1);
	...
	a_class->attributes = (GE_storable_attribute**)GE_calloc(a_class->attribute_count, sizeof(GE_storable_attribute*));
	for (i = 0; i < a_class->attribute_count; i ++) {
		l_attribute = (GE_storable_attribute*)GE_calloc(1, sizeof(GE_storable_attribute));
		a_class->attributes[i] = l_attribute;
		GE_storable_read_attribute(a_buffer, a_data, a_class, l_attribute);
	}
}
...
static void GE_storable_read_attribute(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_class* a_class, GE_storable_attribute* a_attribute)
{
	...
	GE_storable_read_character_8(a_buffer, (EIF_CHARACTER_8*)l_name, nb);
	l_name[nb] = '\0';
	GE_storable_read_natural_8(a_buffer, &(a_attribute->type_kind), 1);
	GE_storable_read_integer_16(a_buffer, &(a_attribute->type_count), 1);
	...
	GE_storable_read_integer_16(a_buffer, a_attribute->types, a_attribute->type_count);
}
...
static void GE_storable_read_objects(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data)
{
	...
	a_data->objects = (GE_storable_object*)GE_calloc(a_data->object_count, sizeof(GE_storable_object));
	for (i = 0; i < a_data->object_count; i++) {
		GE_storable_read_object(a_buffer, a_data, &(a_data->objects[i]));
	}
	GE_storable_resolve_all_addresses(a_data);
}
...
static void GE_storable_read_object(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object)
{
	GE_storable_read_pointer(a_buffer, &(a_object->old_address), 1);
	GE_storable_read_natural_32(a_buffer, &(a_object->flags), 1);
	GE_storable_read_object_type(a_buffer, a_data, a_object);
	GE_storable_read_subobject(a_buffer, a_data, a_object);
}
...
static void GE_storable_read_subobject(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object)
{
	if (a_object->flags & GE_STORABLE_EO_TUPLE) {
		GE_storable_read_tuple_subobject(a_buffer, a_data, a_object);
	} else if (a_object->flags & GE_STORABLE_EO_SPEC) {
		GE_storable_read_special_subobject(a_buffer, a_data, a_object);
	} else {
		GE_storable_read_regular_subobject(a_buffer, a_data, a_object);
	}
}
...
static void GE_storable_read_tuple_subobject(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object)
{
	...
	uint64_t l_pointer;
	GE_storable_object l_expanded_object = {0, 0, 0, 0};
	GE_attribute* l_runtime_attribute;
	EIF_TYPE_INDEX l_runtime_type;
	GE_storable_unresolved_address* l_unresolved_address;
	GE_storable_object* l_other_object;
	...
	GE_storable_read_natural_32(a_buffer, &l_count, 1);
	GE_storable_read_natural_32(a_buffer, &l_capacity, 1);
	l_object = l_new(GE_current_context(), EIF_TRUE);
	a_object->object = l_object;
	while (a_object->unresolved_address && GE_storable_resolve_address(a_data, a_object, a_object->unresolved_address)) {
	...
	GE_storable_read_natural_8(a_buffer, &l_code, 1);
	...
	GE_storable_read_boolean(a_buffer, &l_bool, 1);
	...
	for (i = 1; i < l_count; i++) {
		...
		case GE_STORABLE_TUPLE_REFERENCE_CODE:
			GE_storable_read_pointer(a_buffer, &l_pointer, 1);
			...
			if (GE_type_infos[l_runtime_type].flags & GE_TYPE_FLAG_EXPANDED) {
				...
				l_unresolved_address = GE_new_storable_unresolved_address(l_pointer, l_object, 0, "TUPLE", l_runtime_attribute, 0);
				...
				if (!GE_storable_resolve_address(a_data, l_other_object, l_unresolved_address)) {
		...
		case GE_STORABLE_TUPLE_CHARACTER_8_CODE:
			GE_storable_read_character_8(a_buffer, &l_char8, 1);
		...
		case GE_STORABLE_TUPLE_REAL_64_CODE:
			GE_storable_read_real_64(a_buffer, &l_real64, 1);
		...
		case GE_STORABLE_TUPLE_REAL_32_CODE:
			GE_storable_read_real_32(a_buffer, &l_real32, 1);
		...
		case GE_STORABLE_TUPLE_INTEGER_8_CODE:
			GE_storable_read_integer_8(a_buffer, &l_int8, 1);
		...
		case GE_STORABLE_TUPLE_INTEGER_16_CODE:
			GE_storable_read_integer_16(a_buffer, &l_int16, 1);
		...
		case GE_STORABLE_TUPLE_INTEGER_32_CODE:
			GE_storable_read_integer_32(a_buffer, &l_int32, 1);
		...
		case GE_STORABLE_TUPLE_INTEGER_64_CODE:
			GE_storable_read_integer_64(a_buffer, &l_int64, 1);
		...
		case GE_STORABLE_TUPLE_NATURAL_8_CODE:
			GE_storable_read_natural_8(a_buffer, &l_nat8, 1);
		...
		case GE_STORABLE_TUPLE_NATURAL_16_CODE:
			GE_storable_read_natural_16(a_buffer, &l_nat16, 1);
		...
		case GE_STORABLE_TUPLE_NATURAL_32_CODE:
			GE_storable_read_natural_32(a_buffer, &l_nat32, 1);
		...
		case GE_STORABLE_TUPLE_NATURAL_64_CODE:
			GE_storable_read_natural_64(a_buffer, &l_nat64, 1);
		...
		case GE_STORABLE_TUPLE_CHARACTER_32_CODE:
			GE_storable_read_character_32(a_buffer, &l_char32, 1);
...
static void GE_storable_read_special_subobject(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object)
{
	...
	if (!(l_item_flags & GE_TYPE_FLAG_EXPANDED)) {
		GE_storable_read_integer_8(a_buffer, &l_pointer_size, 1);
		for (i = 0; i < l_count; i++) {
			GE_storable_read_pointer_with_size(a_buffer, &l_pointer, 1, l_pointer_size);
			if (l_pointer) {
				l_unresolved_address = GE_new_storable_unresolved_address(l_pointer, l_object, 0, "SPECIAL", l_runtime_attribute, i);
				l_object_index = l_pointer & 0x000000000FFFFFFF;
				if (l_object_index > 0 && l_object_index <= a_data->object_count) {
					l_object_index--;
				} else {
		...
		GE_storable_read_boolean(a_buffer, (EIF_BOOLEAN*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_CHARACTER_8) {
		GE_storable_read_character_8(a_buffer, (EIF_CHARACTER_8*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_CHARACTER_32) {
		GE_storable_read_character_32(a_buffer, (EIF_CHARACTER_32*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_INTEGER_8) {
		GE_storable_read_integer_8(a_buffer, (EIF_INTEGER_8*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_INTEGER_16) {
		GE_storable_read_integer_16(a_buffer, (EIF_INTEGER_16*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_INTEGER_32) {
		GE_storable_read_integer_32(a_buffer, (EIF_INTEGER_32*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_INTEGER_64) {
		GE_storable_read_integer_64(a_buffer, (EIF_INTEGER_64*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_NATURAL_8) {
		GE_storable_read_natural_8(a_buffer, (EIF_NATURAL_8*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_NATURAL_16) {
		GE_storable_read_natural_16(a_buffer, (EIF_NATURAL_16*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_NATURAL_32) {
		GE_storable_read_natural_32(a_buffer, (EIF_NATURAL_32*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_NATURAL_64) {
		GE_storable_read_natural_64(a_buffer, (EIF_NATURAL_64*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_REAL_32) {
		GE_storable_read_real_32(a_buffer, (EIF_REAL_32*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
	} else if ((l_item_flags & GE_TYPE_FLAG_BASIC_MASK) == GE_TYPE_FLAG_REAL_64) {
		GE_storable_read_real_64(a_buffer, (EIF_REAL_64*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
		...
		if (GE_current_context()->storable_discard_pointer_values) {
			...
			GE_storable_read_pointer(a_buffer, (uint64_t*)GE_field_address_at(l_item_offset, l_object, 0), l_count);
		} else {
			GE_storable_read_integer_8(a_buffer, &l_pointer_size, 1);
			for (i = 0; i < l_count; i++) {
				GE_storable_read_pointer_with_size(a_buffer, &l_pointer, 1, l_pointer_size);
		...
		GE_storable_read_natural_32(a_buffer, &(l_expanded_object.flags), 1);
		GE_storable_read_object_type(a_buffer, a_data, &l_expanded_object);
		...
		for (i = 0; i < l_count; i++) {
			...
			GE_storable_read_subobject(a_buffer, a_data, &l_expanded_object);
		}
	}
}
...
static void GE_storable_read_regular_subobject(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object)
{
	...
	for (i = l_attribute_count - 1; i >= 0; i--) {
		...
		case GE_STORABLE_SK_REF:
			GE_storable_read_pointer(a_buffer, &l_pointer, 1);
			if (l_pointer) {
				l_unresolved_address = GE_new_storable_unresolved_address(l_pointer, l_object, l_physical_offset, l_class->name, l_runtime_attribute, 0);
				l_object_index = l_pointer & 0x000000000FFFFFFF;
				if (l_object_index > 0 && l_object_index <= a_data->object_count) {
					l_object_index--;
				} else {
		...
		case GE_STORABLE_SK_EXP:
			...
			GE_storable_read_pointer(a_buffer, &(l_expanded_object.old_address), 1);
			GE_storable_read_natural_32(a_buffer, &(l_expanded_object.flags), 1);
			GE_storable_read_object_type(a_buffer, a_data, &l_expanded_object);
...
static void GE_storable_read_object_type(GE_storable_read_buffer* a_buffer, GE_storable_data* a_data, GE_storable_object* a_object)
{
	...
	GE_storable_read_natural_32(a_buffer, &nb, 1);
	if (nb <= 0) {
	...
	if (nb == 1) {
		...
		GE_storable_read_integer_32(a_buffer, l_types, nb);
		...
		GE_storable_resolve_object_type(a_buffer, a_data, a_object, &l_types_ptr, &l_type_name_ptr);
		GE_free(l_types);
	}
	a_object->type_id = GE_storable_type_id_from_name(l_type_name);
...
static void GE_storable_resolve_all_addresses(GE_storable_data* a_data)
{
	...
	GE_storable_object* l_objects = a_data->objects;
	int32_t i;
	int32_t j;
	GE_storable_object* l_object;
	GE_storable_unresolved_address* l_address;
	...
	for (i = 0; i < l_object_count; i++) {
		...
		while (l_object->unresolved_address) {
			l_address = l_object->unresolved_address;
			for (j = i - 1; j >= 0; j--) {
				if (GE_storable_resolve_address(a_data, &(l_objects[j]), l_address)){
					l_object->unresolved_address = l_address->next;
					GE_free(l_address);
					l_address = 0;
					break;
...
{
	GE_storable_read_buffer* l_buffer;
	EIF_REFERENCE l_object;

	l_buffer = GE_new_storable_read_buffer_from_file(GE_storable_read, a_file_desc);
	l_object = GE_storable_retrieved_from_buffer(l_buffer);
	GE_free_storable_read_buffer(l_buffer);
	return l_object;
}

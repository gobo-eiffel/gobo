	...
	test_gexace
		...
		do
			...
			xace_filename := file_system.pathname (sample_dirname, "system2.xace")
				-- Generate Xace file.
			expected_output_filename := file_system.pathname (sample_dirname, "ge2.xace")
			...
			assert_files_equal ("diff2a", expected_output_filename, "ge.xace")
				--
...
feature {NONE} -- Implementation
	...
	sample_dirname: STRING
		...
		once
			Result := file_system.nested_pathname ("${GOBO}", <<"tool", "gexace", "test", "tool", "data">>)

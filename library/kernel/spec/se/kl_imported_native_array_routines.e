...
feature -- Type anchors
	...
	NATIVE_ANY_ARRAY_TYPE: NATIVE_ARRAY [ANY] is do end
	NATIVE_BOOLEAN_ARRAY_TYPE: NATIVE_ARRAY [BOOLEAN] is do end
	NATIVE_CHARACTER_ARRAY_TYPE: NATIVE_ARRAY [CHARACTER] is do end
	NATIVE_INTEGER_ARRAY_TYPE: NATIVE_ARRAY [INTEGER] is do end
	NATIVE_STRING_ARRAY_TYPE: NATIVE_ARRAY [STRING] is do end

note
	...
	description:
		...
		"Special objects of POINTER objects read from Storable files"

	library: "Gobo Eiffel Storable Library"
	copyright: "Copyright (c) 2025, Eric Bezault and others"
	license: "MIT License"

class SB_SPECIAL_POINTER_OBJECT
...
feature {NONE} -- Initialization
	...
	make (a_type: like type; a_flags: like flags; an_address: like address; a_count: like count)
			-- Create a new empty special object of POINTERs.
		require
...
feature -- Output
	...
	item_out (i: INTEGER): STRING
		...
		do
			Result := "<0x" + item (i).to_hex_string + ">"
		end

feature -- Status report

	is_special_pointer: BOOLEAN = True

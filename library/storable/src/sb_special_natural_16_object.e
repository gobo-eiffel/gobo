note
	...
	description:
		...
		"Special objects of NATURAL_16 objects read from Storable files"

	library: "Gobo Eiffel Storable Library"
	copyright: "Copyright (c) 2025, Eric Bezault and others"
	license: "MIT License"

class SB_SPECIAL_NATURAL_16_OBJECT

inherit

	SB_SPECIAL_BASIC_OBJECT
		redefine
			is_special_natural_16
		end
...
feature {NONE} -- Initialization
	...
	make (a_type: like type; a_flags: like flags; an_address: like address; a_count: like count)
			-- Create a new empty special object of NATURAL_16s.
		require
...
feature -- Access
	...
	item_type (a_schema: SB_SCHEMA): SB_TYPE
		...
		do
			Result := a_schema.natural_16_type
		end
...
feature -- Status report
	...
	is_special_natural_16: BOOLEAN = True

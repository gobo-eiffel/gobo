note
	...
	description:
		...
		"Special objects of BOOLEAN objects read from Storable files"

	library: "Gobo Eiffel Storable Library"
	copyright: "Copyright (c) 2025, Eric Bezault and others"
	license: "MIT License"

class SB_SPECIAL_BOOLEAN_OBJECT
...
feature {NONE} -- Initialization
	...
	make (a_type: like type; a_flags: like flags; an_address: like address; a_count: like count)
			-- Create a new empty special object of BOOLEANs.
		require
		...
		do
			...
			capacity := a_count
			elem_size := 0
			create items.make_filled (False, count)
		ensure
...
feature -- Status report
	...
	is_special_boolean: BOOLEAN = True

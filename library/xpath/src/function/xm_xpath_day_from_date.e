note
	...
	description:
		...
		"Objects that implement the XPath day-from-date() function"

	library: "Gobo Eiffel XPath Library"
	copyright: "Copyright (c) 2005-2015, Colin Adams and others"
	license: "MIT License"

class XM_XPATH_DAY_FROM_DATE
...
feature {NONE} -- Initialization
	...
	make
		...
		do
			...
			fingerprint := Day_from_date_function_type_code
	...
	evaluate_item (a_result: DS_CELL [detachable XM_XPATH_ITEM]; a_context: XM_XPATH_CONTEXT)
		...
		do
			...
			if attached a_result.item as a_result_item and then not a_result_item.is_error then
				...
				a_result.put (create {XM_XPATH_MACHINE_INTEGER_VALUE}.make (l_date_value.date.day))
			end
		end

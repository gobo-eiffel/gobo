...
feature {NONE} -- Initialization
	...
	make (filename: STRING; line: INTEGER; a_type: PR_TYPE; a_new_alias_name: STRING) is
...
feature -- Access
	...
	default_template: STRING is "%"$1%", line $2: alias name '$4' for type '$3' should have been defined in previous %%token declarations with that type"
			-- Default template used to built the error message

	code: STRING is "PR0030"
			-- Error code

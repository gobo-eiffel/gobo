...
feature -- Comparison
	...
	infix "<" (other: NATURAL_32): BOOLEAN is
...
feature -- Basic operations
	...
	infix "+" (other: NATURAL_32): NATURAL_32 is
			-- Sum with `other'
		external
			"built_in"
		end
	...
	infix "/" (other: NATURAL_32): REAL_64 is
			-- Division by `other'
		external
			"built_in"
		end

	prefix "+": NATURAL_32 is
			-- Unary plus
		external
			"built_in"
		end
...
feature -- Bit operations
	...
	bit_and (i: NATURAL_32): NATURAL_32 is
			-- Bitwise and between Current' and `i'.
		external
			"built_in"
		end

	bit_or (i: NATURAL_32): NATURAL_32 is
	...
	bit_shift_left (n: INTEGER): NATURAL_32 is
			-- Shift Current from `n' position to left.
		external
			"built_in"
		end

	bit_shift_right (n: INTEGER): NATURAL_32 is

...
feature -- Comparison
	...
	is_less alias "<" (other: INTEGER_16): BOOLEAN is
...
feature -- Basic operations
	...
	plus alias "+" (other: INTEGER_16): INTEGER_16 is
			-- Sum with `other'
		external
			"built_in"
		end

	minus alias "-" (other: INTEGER_16): INTEGER_16 is
			-- Result of subtracting `other'
		external
			"built_in"
		end

	product alias "*" (other: INTEGER_16): INTEGER_16 is
			-- Product by `other'
		external
			"built_in"
		end

	quotient alias "/" (other: INTEGER_16): REAL_64 is
			-- Division by `other'
		external
			"built_in"
		end

	identity alias "+": INTEGER_16 is
			-- Unary plus
		external
			"built_in"
		end

	opposite alias "-": INTEGER_16 is
			-- Unary minus
		external
			"built_in"
		end

	integer_quotient alias "//" (other: INTEGER_16): INTEGER_16 is
			-- Integer division of Current by `other'
		external
			"built_in"
		end

	integer_remainder alias "\\" (other: INTEGER_16): INTEGER_16 is
...
feature -- Bit operations
	...
	bit_and alias "&" (i: INTEGER_16): INTEGER_16 is
			-- Bitwise and between Current' and `i'.
		external
			"built_in"
		end

	bit_or alias "|" (i: INTEGER_16): INTEGER_16 is
	...
	bit_shift_left alias "|<<" (n: INTEGER): INTEGER_16 is
			-- Shift Current from `n' position to left.
		external
			"built_in"
		end

	bit_shift_right alias "|>>" (n: INTEGER): INTEGER_16 is

...
feature -- Access
	...
	Min_value: INTEGER_32 is -2147483648
	Max_value: INTEGER_32 is 2147483647
...
feature -- Basic operations
	...
	quotient alias "/" (other: like Current): REAL_64 is
			-- Division by `other'
		require
...
feature {NONE} -- Initialization
	...
	make_from_reference (v: INTEGER_32_REF) is
...
feature -- Conversion
	...
	to_reference: INTEGER_32_REF is
	...
	frozen to_integer, frozen to_integer_32: INTEGER_32 is
			-- Return `item'.
		do
			Result := item
		end
...
feature -- Bit operations
	...
	bit_and alias "&" (i: like Current): like Current is
	...
	bit_or alias "|" (i: like Current): like Current is
	...
	frozen bit_shift (n: INTEGER_32): INTEGER is
	...
	bit_shift_left alias "|<<" (n: INTEGER): like Current is
	...
	bit_shift_right alias "|>>" (n: INTEGER): like Current is
	...
	frozen set_bit (b: BOOLEAN; n: INTEGER): INTEGER_32 is
	...
	frozen set_bit_with_mask (b: BOOLEAN; m: INTEGER_32): INTEGER_32 is

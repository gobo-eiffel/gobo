...
feature -- Bit operations
	...
	bit_and alias "&" (i: INTEGER_8): INTEGER_8 is
			-- Bitwise and between Current' and `i'.
		external
			"built_in"
		end

	bit_or alias "|" (i: INTEGER_8): INTEGER_8 is
	...
	bit_shift_left alias "|<<" (n: INTEGER): INTEGER_8 is
			-- Shift Current from `n' position to left.
		external
			"built_in"
		end

	bit_shift_right alias "|>>" (n: INTEGER): INTEGER_8 is

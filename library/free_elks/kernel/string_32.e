...
feature -- Initialization
	...
	make_filled (c: CHARACTER_32; n: INTEGER) is
...
feature -- Access
	...
	item, infix "@" (i: INTEGER): CHARACTER_32 assign put is
	...
	index_of (c: CHARACTER_32; start_index: INTEGER): INTEGER is
	...
	last_index_of (c: CHARACTER_32; start_index_from_end: INTEGER): INTEGER is
...
feature -- Measurement
	...
	occurrences (c: CHARACTER_32): INTEGER is
...
feature -- Status report
	...
	starts_with (s: STRING_32): BOOLEAN is
	...
	ends_with (s: STRING_32): BOOLEAN is
...
feature -- Element change
	...
	replace_character (c: CHARACTER_32) is
			-- Replace every character with `c'.
		obsolete
	...
	fill_character (c: CHARACTER_32) is
	...
	put (c: CHARACTER_32; i: INTEGER) is
	...
	precede, prepend_character (c: CHARACTER_32) is
			-- Add `c' at front.
		local
			l_area: like area
		do
	...
	append_character, extend (c: CHARACTER_32) is
			-- Append `c' at end.
		local
			current_count: INTEGER
		do
	...
	insert_character (c: CHARACTER_32; i: INTEGER) is
...
feature -- Removal
	...
	prune_all_leading (c: CHARACTER_32) is
	...
	prune_all_trailing (c: CHARACTER_32) is
...
feature -- Conversion
	...
	character_justify (pivot: CHARACTER_32; position: INTEGER) is
	...
	to_boolean: BOOLEAN is
		...
		do
			...
			to_boolean: (Result = true_constant.same_string (as_lower.as_string_8)) or
				(not Result = false_constant.same_string (as_lower.as_string_8))
		end

	linear_representation: LINEAR [CHARACTER_32] is
	...
	split (a_separator: CHARACTER_32): LIST [STRING_32] is

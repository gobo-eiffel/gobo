...
feature -- Basic operations
	...
	minus alias "-" alias "−" (other: NATURAL_64): NATURAL_64
			-- Result of subtracting `other'
		external
			"built_in"
		end

	product alias "*" alias "×" (other: NATURAL_64): NATURAL_64
			-- Product by `other'
		external
			"built_in"
		end

	quotient alias "/" alias "÷" (other: NATURAL_64): REAL_64
			-- Division by `other'
		external
			"built_in"
		end
...
feature -- Bit operations
	...
	bit_and alias "&" alias "⊗" (i: NATURAL_64): NATURAL_64
			-- Bitwise and between Current' and `i'.
		external
			"built_in"
		end

	bit_or alias "|" alias "⦶" (i: NATURAL_64): NATURAL_64
			-- Bitwise or between Current' and `i'.
		external
			"built_in"
		end

	bit_xor alias "⊕" (i: NATURAL_64): NATURAL_64
			-- Bitwise xor between Current' and `i'.
		external
			"built_in"
		end

	bit_not alias "⊝": NATURAL_64
			-- One's complement of Current.
		external
			"built_in"
		end

	bit_shift_left alias "|<<" alias "⧀" (n: INTEGER): NATURAL_64
			-- Shift Current from `n' position to left.
		external
			"built_in"
		end

	bit_shift_right alias "|>>" alias "⧁" (n: INTEGER): NATURAL_64

...
feature -- Conversion
	...
	to_binary_string: STRING_8
		...
		do
			...
			result_valid_count: Result.count = {PLATFORM}.integer_64_bits
	...
	to_octal_string: STRING_8
		...
		do
			from
				i := ({PLATFORM}.integer_64_bits / 3).ceiling_real_64.truncated_to_integer
				create Result.make_filled ('0', i)
				val := item
			until
				i = 0
			...
			result_not_void: Result /= Void
			result_valid_count: Result.count = ({PLATFORM}.integer_64_bits / 3).ceiling_real_64.truncated_to_integer

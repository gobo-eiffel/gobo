...
feature -- Test
	...
	test_out
		...
		do
			...
			assert_equal ("max_value", "4294967295", l_out)
	...
	test_item
		...
		do
			...
			assert ("item3", ({INTEGER} 25).item = 25)
			assert ("item4", ({INTEGER} 100).item = 100)
		end
		...
		do
			if not eiffel_compiler.is_ise then
				...
				assert ("item3", (5).item = 5)
					...
					-- function.
				({NATURAL_32} 5 + {NATURAL_32} 6).set_item (100)
				assert ("item4", ({NATURAL_32} 5 + {NATURAL_32} 6).item = 11)
			end
		end
	...
	test_bit_and
		...
		do
			...
			i2 := 4 -- 00000000000000000000000000000100
			i3 := 4 -- 00000000000000000000000000000100
			assert ("bit_and1", i1.bit_and (i2) = i3)
			i1 := 5 --          00000000000000000000000000000101
			i2 := 4294967291 -- 11111111111111111111111111111011
			i3 := 1 --          00000000000000000000000000000001
	...
	test_bit_or
		...
		do
			i1 := 5 -- 00000000000000000000000000000101
			i2 := 4 -- 00000000000000000000000000000100
			i3 := 5 -- 00000000000000000000000000000101
			assert ("bit_or1", i1.bit_or (i2) = i3)
			i1 := 5 --  00000000000000000000000000000101
			i2 := 4294967291 -- 11111111111111111111111111111011
			i3 := 4294967295 -- 11111111111111111111111111111111
	...
	test_bit_xor
		...
		do
			...
			i1 := 5 --  00000000000000000000000000000101
			i2 := 4294967291 -- 11111111111111111111111111111011
			i3 := 4294967294 -- 11111111111111111111111111111110
	...
	test_bit_not
		...
		do
			i1 := 5 --          00000000000000000000000000000101
			i2 := 4294967290 -- 11111111111111111111111111111010
			assert ("bit_not1", i1.bit_not = i2)
			i1 := 4294967294 -- 11111111111111111111111111111110
	...
	test_bit_shift_left
		...
		do
			i1 := 5 --  00000000000000000000000000000101
			i2 := 10 -- 00000000000000000000000000001010
			assert ("bit_shift_left1", i1.bit_shift_left (1) = i2)
			i1 := 4294967291 -- 11111111111111111111111111111011
			i2 := 4294967286 -- 11111111111111111111111111110110
			assert ("bit_shift_left2", i1.bit_shift_left (1) = i2)
			i1 := 2147483647 -- 01111111111111111111111111111111
			i2 := 4294967294 -- 11111111111111111111111111111110
			assert ("bit_shift_left3", i1.bit_shift_left (1) = i2)
			i1 := 2147483648 -- 10000000000000000000000000000000
	...
	test_bit_shift_right
		...
		do
			...
			i1 := 4294967291 -- 11111111111111111111111111111011
			i2 := 2147483645 -- 01111111111111111111111111111101

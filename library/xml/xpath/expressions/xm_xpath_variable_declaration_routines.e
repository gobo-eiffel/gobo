...
feature -- Access
	...
	variable_reference_count (a_reference_list: DS_ARRAYED_LIST [XM_XPATH_BINDING_REFERENCE]; a_binding: XM_XPATH_BINDING): INTEGER is
		...
		local
			...
			an_assignation: XM_XPATH_ASSIGNATION
		...
		do
			...
			if Result = 1 then
				...
				if a_variable_reference /= Void then
					...
					Result := 0 -- This shouldn't happen, I think
				end
			end
		end

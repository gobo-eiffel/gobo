		...
		do
			...
			elseif a_item.is_error then
				...
				if a_item.is_boolean_value then
					Result := a_item.as_boolean_value.convert_to_type (type_factory.double_type).as_double_value
				elseif a_item.is_numeric_value then
					Result := a_item.as_numeric_value.convert_to_type (type_factory.double_type).as_double_value
				else

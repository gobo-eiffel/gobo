   ...
   XI_NODE
	...
	DS_BILINEAR [XM_NODE]
		...
		export
			...
			{XM_COMPOSITE, DS_CURSOR}

				cursor_item, cursor_same_position, cursor_go_to,

				cursor_is_first, cursor_after, cursor_start,

				cursor_forth, cursor_search_forth, cursor_go_after,

				cursor_is_last, cursor_before, cursor_finish,

				cursor_back, cursor_search_back, cursor_go_before,

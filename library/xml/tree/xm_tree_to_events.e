...
feature -- Node processor
	...
	process_element (an_element: XM_ELEMENT) is
			-- Process element.
		do
	...
	process_attribute (an_attribute: XM_ATTRIBUTE) is
		do
	...
	process_character_data (a_data: XM_CHARACTER_DATA) is
	...
	process_comment (a_comment: XM_COMMENT) is
		do
			process_start_tag_finish

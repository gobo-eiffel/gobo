note
	...
	description:
		...
		"LSP handlers for 'completionItem/resolve' requests"

	library: "Gobo Eiffel Language Server Protocol Library"
	copyright: "Copyright (c) 2025, Eric Bezault and others"
	license: "MIT License"

class LS_COMPLETION_ITEM_RESOLVE_REQUEST_HANDLER
...
feature -- Setting
	...
	build_server_options
		...
		do
			...
			elseif not generating_type.same_type ({detachable LS_COMPLETION_ITEM_RESOLVE_REQUEST_HANDLER}) then
...
feature {NONE} -- Implementation
	...
	request: LS_COMPLETION_ITEM_RESOLVE_REQUEST
			-- Type of request to be handled by current handler
		do
			check False then end
		end

	response_result: LS_COMPLETION_ITEM

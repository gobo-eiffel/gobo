note
	...
	description:
		...
		"LSP 'textDocument/implementation' requests"

	library: "Gobo Eiffel Language Server Protocol Library"
	copyright: "Copyright (c) 2025, Eric Bezault and others"
	license: "MIT License"

class LS_IMPLEMENTATION_REQUEST

inherit

	LS_REQUEST

	LS_IMPLEMENTATION_PARAMS
...
feature {NONE} -- Initialization
	...
	make (a_id: like id; a_text_document: like text_document; a_position: like position; a_work_done_token: like work_done_token; a_partial_result_token: like partial_result_token)
			-- Create a new 'textDocument/implementation' request.
		require
...
feature -- Access
	...
	handler (a_manager: LS_MESSAGE_MANAGER): LS_IMPLEMENTATION_REQUEST_HANDLER
		...
		do
			Result := a_manager.implementation_request_handler
		ensure then
			instance_free: class
		end
...
feature -- Processing
	...
	process (a_processor: LS_PROCESSOR)
		...
		do
			a_processor.process_implementation_request (Current)
		end

note
	...
	description:
		...
		"LSP 'textDocument/documentHighlight' dynamic registration options"

	library: "Gobo Eiffel Language Server Protocol Library"
	copyright: "Copyright (c) 2026, Eric Bezault and others"
	license: "MIT License"

class LS_DOCUMENT_HIGHLIGHT_REGISTRATION_OPTIONS
...
inherit
	...
	LS_DOCUMENT_HIGHLIGHT_OPTIONS
		rename
			make as make_document_highlight_options
		redefine
			process
		end
...
feature -- Processing
	...
	process (a_processor: LS_PROCESSOR)
		...
		do
			a_processor.process_document_highlight_registration_options (Current)
		end

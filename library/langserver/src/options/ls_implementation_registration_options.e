note
	...
	description:
		...
		"LSP 'textDocument/implementation' dynamic registration options"

	library: "Gobo Eiffel Language Server Protocol Library"
	copyright: "Copyright (c) 2025, Eric Bezault and others"
	license: "MIT License"

class LS_IMPLEMENTATION_REGISTRATION_OPTIONS
...
inherit
	...
	LS_IMPLEMENTATION_OPTIONS
		rename
			make as make_implementation_options
		redefine
			process
		end
...
feature -- Processing
	...
	process (a_processor: LS_PROCESSOR)
		...
		do
			a_processor.process_implementation_registration_options (Current)
		end

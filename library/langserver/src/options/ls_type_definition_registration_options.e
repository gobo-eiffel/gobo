note
	...
	description:
		...
		"LSP 'textDocument/typeDefinition' dynamic registration options"

	library: "Gobo Eiffel Language Server Protocol Library"
	copyright: "Copyright (c) 2025, Eric Bezault and others"
	license: "MIT License"

class LS_TYPE_DEFINITION_REGISTRATION_OPTIONS
...
inherit
	...
	LS_TYPE_DEFINITION_OPTIONS
		rename
			make as make_type_definition_options
		redefine
			process
		end
...
feature -- Processing
	...
	process (a_processor: LS_PROCESSOR)
		...
		do
			a_processor.process_type_definition_registration_options (Current)
		end

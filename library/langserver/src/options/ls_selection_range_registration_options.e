note
	...
	description:
		...
		"LSP 'textDocument/selectionRange' dynamic registration options"

	library: "Gobo Eiffel Language Server Protocol Library"
	copyright: "Copyright (c) 2026, Eric Bezault and others"
	license: "MIT License"

class LS_SELECTION_RANGE_REGISTRATION_OPTIONS
...
inherit
	...
	LS_SELECTION_RANGE_OPTIONS
		rename
			make as make_selection_range_options
		redefine
			process
		end
...
feature -- Processing
	...
	process (a_processor: LS_PROCESSOR)
		...
		do
			a_processor.process_selection_range_registration_options (Current)
		end

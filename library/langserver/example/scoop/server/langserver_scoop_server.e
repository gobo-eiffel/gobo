note
	...
	description:
		...
		"LSP example SCOOP servers"

	library: "Gobo Eiffel Language Server Protocol Library"
	copyright: "Copyright (c) 2025, Eric Bezault and others"
	license: "MIT License"

class LANGSERVER_SCOOP_SERVER
...
feature -- Access
	...
	application_info: detachable LS_APPLICATION_INFO
		...
		do
			create Result.make ("langserver", "2.0.1")
		end

feature -- Handlers

	hover_request_handler: LANGSERVER_SERVER_HOVER_REQUEST_HANDLER

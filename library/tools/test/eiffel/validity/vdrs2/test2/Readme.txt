...
TEST DESCRIPTION:
----------------------------------------------------------------------
The Redefine subclause of parent CC in class BB lists `f' which
is the final name in BB of a constant attribute inherited from CC.
Validity VDRS-2 is violated.
----------------------------------------------------------------------

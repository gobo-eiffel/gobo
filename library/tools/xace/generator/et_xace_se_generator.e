...
feature {NONE} -- Output
	...
	print_exported_classes (a_classes: DS_LINKED_LIST [ET_XACE_EXPORTED_CLASS]; a_file: KL_OUTPUT_FILE) is
	...
	print_exported_class (a_class: ET_XACE_EXPORTED_CLASS; a_file: KL_OUTPUT_FILE) is

...
feature -- Access
	...
	option_names_1_16_0: DS_HASH_SET [STRING]
			-- Names of options supported in ECF 1.16.0
		local
			l_hash_function: KL_AGENT_HASH_FUNCTION [STRING]
		once
			...
			Result.force_last ({ET_ECF_OPTION_NAMES}.debug_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.full_class_checking_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.is_attached_by_default_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.is_obsolete_routine_type_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.msil_application_optimize_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.namespace_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.optimize_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.profile_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.syntax_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.trace_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_option_name)
		ensure
			option_names_not_void: Result /= Void
			no_void_option_name: not Result.has_void
		end

	assertion_names_1_16_0: DS_HASH_SET [STRING]
			-- Names of assertions supported in ECF 1.16.0
		local
			l_hash_function: KL_AGENT_HASH_FUNCTION [STRING]
		once
			...
			create l_hash_function.make (agent STRING_.case_insensitive_hash_code)
			Result.set_hash_function (l_hash_function)
			Result.force_last ({ET_ECF_OPTION_NAMES}.assertions_precondition_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.assertions_postcondition_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.assertions_check_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.assertions_invariant_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.assertions_loop_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.assertions_supplier_precondition_option_name)
		ensure
			assertion_names_not_void: Result /= Void
			no_void_assertion_name: not Result.has_void
		end

	warning_names_1_16_0: DS_HASH_SET [STRING]
			-- Names of warnings supported in ECF 1.16.0
		local
			l_hash_function: KL_AGENT_HASH_FUNCTION [STRING]
		once
			create Result.make (15)
			...
			create l_hash_function.make (agent STRING_.case_insensitive_hash_code)
			Result.set_hash_function (l_hash_function)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_export_class_missing_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_obsolete_class_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_obsolete_feature_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_old_verbatim_strings_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_once_in_generic_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_option_unknown_class_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_renaming_unknown_class_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_same_uuid_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_syntax_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_unused_local_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_vjrv_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_vwab_option_name)
			Result.force_last ({ET_ECF_OPTION_NAMES}.warning_vweq_option_name)
		ensure
			warning_names_not_void: Result /= Void

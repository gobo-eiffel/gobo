...
feature -- Type processing
	...
	resolved_formal_parameters (a_parameters: ET_ACTUAL_PARAMETERS): ET_LIKE_TYPE
	...
	resolved_formal_parameters_with_type_mark (a_type_mark: detachable ET_TYPE_MARK; a_parameters: ET_ACTUAL_PARAMETERS): ET_LIKE_TYPE

...
feature -- Iteration
	...
	do_all (an_action: PROCEDURE [ET_LIBRARY])
	...
	do_if (an_action: PROCEDURE [ET_LIBRARY]; a_test: FUNCTION [ET_LIBRARY, BOOLEAN])
	...
	do_recursive (an_action: PROCEDURE [ET_LIBRARY])

note
	...
	description:
		...
		"Eiffel fake qualified feature call expressions, with no possible processing"
...
class ET_FAKE_QUALIFIED_FEATURE_CALL_EXPRESSION
...
feature {NONE} -- Initialization
	...
	make (a_target: like target; a_name: like name; a_arguments: like arguments)
			-- Create a new fake qualified feature call expression.
		require

note
	...
	description: "[
		Eiffel qualified feature call expressions, with no specific associated concrete
		syntax as opposed to other descendants of ET_QUALIFIED_FEATURE_CALL_EXPRESSION.
		Useful when creating qualified feature call expression objects on the fly with
...
class ET_GENERAL_QUALIFIED_FEATURE_CALL_EXPRESSION
...
feature {NONE} -- Initialization
	...
	make (a_target: like target; a_name: like name; a_arguments: like arguments)
			-- Create a new general qualified feature call expression.
		require
...
feature -- Processing
	...
	process (a_processor: ET_AST_PROCESSOR)
		...
		do
			a_processor.process_general_qualified_feature_call_expression (Current)
		end

...
feature -- Status report
	...
	has_result: BOOLEAN
			-- Does the entity 'Result' appear in one of the when parts
	...
	has_address_expression: BOOLEAN
			-- Does an address expression appear in one of the when parts
			-- or (recursively) in one of their subexpressions?
		local
			i, nb: INTEGER
		do
	...
	has_agent: BOOLEAN
			-- Does an agent appear in one of the when parts
			-- or (recursively) in one of their subexpressions?
		local
			i, nb: INTEGER
		do
	...
	has_typed_object_test: BOOLEAN
			-- Does a typed object-test appear in one of the when parts
			-- or (recursively) in one of their subexpressions?
		local
			i, nb: INTEGER
		do

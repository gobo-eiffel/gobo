...
feature -- Token codes
	...
	E_TRUE: INTEGER = 325
	E_BREAK: INTEGER = 326
	E_CHARACTER: INTEGER = 327
	E_CURRENT: INTEGER = 328
	E_FREEOP: INTEGER = 329
	E_IDENTIFIER: INTEGER = 330
	E_TUPLE: INTEGER = 331
	E_NONE: INTEGER = 332
	E_INTEGER: INTEGER = 333
	E_AND: INTEGER = 334
	E_OR: INTEGER = 335
	E_XOR: INTEGER = 336
	E_NOT: INTEGER = 337
	E_IMPLIES: INTEGER = 338
	E_STRPLUS: INTEGER = 339
	E_STRMINUS: INTEGER = 340
	E_STRSTAR: INTEGER = 341
	E_STRSLASH: INTEGER = 342
	E_STRDIV: INTEGER = 343
	E_STRMOD: INTEGER = 344
	E_STRPOWER: INTEGER = 345
	E_STRLT: INTEGER = 346
	E_STRLE: INTEGER = 347
	E_STRGT: INTEGER = 348
	E_STRGE: INTEGER = 349
	E_STRAND: INTEGER = 350
	E_STROR: INTEGER = 351
	E_STRXOR: INTEGER = 352
	E_STRANDTHEN: INTEGER = 353
	E_STRORELSE: INTEGER = 354
	E_STRDOTDOT: INTEGER = 355
	E_STRBRACKET: INTEGER = 356
	E_STRPARENTHESIS: INTEGER = 357

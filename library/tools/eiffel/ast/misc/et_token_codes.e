...
feature -- Keyword and symbol codes
	...
	assign_keyword_code: CHARACTER is '%/127/'
	...
	note_keyword_code: CHARACTER is '%/36/'
	obsolete_keyword_code: CHARACTER is '%/37/'
	old_keyword_code: CHARACTER is '%/38/'
	once_keyword_code: CHARACTER is '%/39/'
	precursor_keyword_code: CHARACTER is '%/40/'
	prefix_keyword_code: CHARACTER is '%/41/'
	...
	void_keyword_code: CHARACTER is '%/58/'
	when_keyword_code: CHARACTER is '%/59/'

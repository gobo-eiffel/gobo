...
feature -- Validity errors
	...
	report_vjar0c_error (a_class: ET_CLASS; a_typed_expression: ET_TYPED_EXPRESSION; a_source_type, a_target_type: ET_NAMED_TYPE) is
			-- Report VJAR error: the source expression of `a_typed_expression' does
			-- not conform to its target types.
			--
			-- ETL2: p. 311
		require
			a_class_not_void: a_class /= Void
		...
		do
			if reportable_vjar_error (a_class) then
				create an_error.make_vjar0c (a_class, a_typed_expression, a_source_type, a_target_type)
				report_validity_error (an_error)
			end
		end

	report_vjar0d_error (a_class, a_class_impl: ET_CLASS; a_typed_expression: ET_TYPED_EXPRESSION; a_source_type, a_target_type: ET_NAMED_TYPE) is
			-- Report VJAR error: the source expression of `a_typed_expression' does
		...
		do
			if reportable_vjar_error (a_class) then
				create an_error.make_vjar0d (a_class, a_class_impl, a_typed_expression, a_source_type, a_target_type)
				report_validity_error (an_error)
			end
		end

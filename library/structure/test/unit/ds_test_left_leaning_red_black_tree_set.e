...
feature -- Test
	...
	test_left_leaning_red_black_tree_set
	...
	test_left_leaning_red_black_tree_set_cursor
	...
	test_void
		...
		local
			l_set: DS_LEFT_LEANING_RED_BLACK_TREE_SET [detachable STRING]
	...
	test_copy
		...
		local
			...
			l_tree_1, l_tree_2: DS_LEFT_LEANING_RED_BLACK_TREE_SET [STRING]
		do
			create l_comparator.make
	...
	test_set_operations
		...
		local
			l_comparator: KL_COMPARABLE_COMPARATOR [INTEGER]
			l_tree_1, l_tree_2, l_tree_3: DS_LEFT_LEANING_RED_BLACK_TREE_SET [INTEGER]
		do
			create l_comparator.make
			create l_tree_1.make (l_comparator)

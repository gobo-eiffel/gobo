note
	...
	description:
		...
		"Test features of class DS_AVL_TREE_SET"

	library: "Gobo Eiffel Structure Library"
	copyright: "Copyright (c) 2008-2018, Daniel Tuser and others"
	license: "MIT License"

class DS_TEST_AVL_TREE_SET
...
feature -- Test
	...
	test_avl_tree_set_cursor
		...
		local
			l_comparator: KL_COMPARABLE_COMPARATOR [INTEGER]
			l_tree: DS_AVL_TREE_SET [INTEGER]
	...
	test_void
		...
		local
			l_set: DS_AVL_TREE_SET [detachable STRING]
	...
	test_copy
		...
		local
			...
			l_tree_1, l_tree_2: DS_AVL_TREE_SET [STRING]
		do
			create l_comparator.make

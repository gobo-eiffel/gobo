note
	...
	description:
		...
		"Test features of class DS_LEFT_LEANING_RED_BLACK_TREE"
...
class DS_TEST_LEFT_LEANING_RED_BLACK_TREE
...
feature -- Test
	...
	test_left_leaning_red_black_tree_cursor
	...
	test_void
			-- Test with Void keys.
		local
			l_tree: DS_LEFT_LEANING_RED_BLACK_TREE [INTEGER, detachable STRING]
	...
	test_do_all
		...
		local
			...
			l_tree: DS_LEFT_LEANING_RED_BLACK_TREE [INTEGER, STRING]
	...
	test_copy
		...
		local
			l_comparator: KL_COMPARABLE_COMPARATOR [STRING]
			l_tree_1, l_tree_2: DS_LEFT_LEANING_RED_BLACK_TREE [INTEGER, STRING]
		do
			create l_comparator.make

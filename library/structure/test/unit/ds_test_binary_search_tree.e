note
	...
	description:
		...
		"Test features of class DS_BINARY_SEARCH_TREE"

	library: "Gobo Eiffel Structure Library"
	copyright: "Copyright (c) 2008-2018, Daniel Tuser and others"
	license: "MIT License"

class DS_TEST_BINARY_SEARCH_TREE
...
feature -- Test
	...
	test_binary_search_tree
		...
		local
			...
			l_tree: DS_BINARY_SEARCH_TREE [INTEGER, INTEGER]
		do
	...
	test_binary_search_tree_cursor
	...
	test_void
			-- Test with Void keys.
		local
			l_tree: DS_BINARY_SEARCH_TREE [INTEGER, detachable STRING]
	...
	test_do_all
		...
		local
			...
			l_tree: DS_BINARY_SEARCH_TREE [INTEGER, STRING]
	...
	test_copy
		...
		local
			l_comparator: KL_COMPARABLE_COMPARATOR [STRING]
			l_tree_1, l_tree_2: DS_BINARY_SEARCH_TREE [INTEGER, STRING]
		do
			create l_comparator.make

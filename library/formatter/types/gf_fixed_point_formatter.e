...
feature {GF_ABSTRACT_FORMATTER} -- Output implementation
	...
	produce_piece (i: INTEGER; p: INTEGER): STRING is
		local
			f_f: GF_UNSIGNED_DECIMAL_INTEGER_FORMATTER
		do
			create f_f.make
			f_f.set_value (i)
			f_f.set_precision (p)
...
feature {NONE} -- Implementation
	...
	integer_formatter: GF_INTEGER_FORMATTER

...
class XM_XSLT_TEST_ANALYZE_STRING
...
feature -- Tests
	...
	test_replacing_characters
		...
		do
			...
			assert ("Correct result", STRING_.same_string (l_last_output.out, expected_result_string_one))
		end
	...
	test_regex_group_one
		...
		do
			...
			assert ("set_output_to_string", l_last_output /= Void)
			check asserted_above: l_last_output /= Void then end
			assert ("Correct result", STRING_.same_string (l_last_output.out, expected_result_string_two))
		end
	...
	test_regex_group_two
		...
		do
			...
			assert ("set_output_to_string", l_last_output /= Void)
			check asserted_above: l_last_output /= Void then end
			assert ("Correct result", STRING_.same_string (l_last_output.out, expected_result_string_three))
		end

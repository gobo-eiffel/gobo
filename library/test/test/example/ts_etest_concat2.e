...
feature {NONE} -- Implementation
	...
	expected_output1: STRING
		...
		once
			Result := file_system.nested_pathname ("${GOBO}", <<"library", "test", "test", "example", "data", "concat2a.log">>)
	...
	expected_output2: STRING
		...
		once
			Result := file_system.nested_pathname ("${GOBO}", <<"library", "test", "test", "example", "data", "concat2b.log">>)
			Result := Execution_environment.interpreted_string (Result)
		ensure
	...
	expected_output3: STRING
		...
		once
			Result := file_system.nested_pathname ("${GOBO}", <<"library", "test", "test", "example", "data", "concat2c.log">>)
			Result := Execution_environment.interpreted_string (Result)
		ensure

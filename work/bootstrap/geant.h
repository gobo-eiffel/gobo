...
/*C Header Pass 4 :*/
struct S323{Tid id;T0* _container;T6 _after;T6 _before;T0* _current_cell;T0* _next_cursor;};
extern T323 M323;
struct S164{Tid id;T2 _count;T2 _capacity;T0* _storage;T0* _FIXED_ARRAY_;T0* _internal_cursor;};
extern T164 M164;
struct S243{Tid id;T0* _event_parser_factory;};
extern T243 M243;
struct S295{Tid id;T0* _command;};
extern T295 M295;
...
struct S138{Tid id;};
extern T138 M138;
struct S312{Tid id;T0* _first;T0* _second;};
extern T312 M312;
struct S135{Tid id;T2 _position;T0* _container;T0* _next_cursor;};
extern T135 M135;
struct S272{Tid id;T6 _push_back_flag;T2 _memory;T0* _name;};
extern T272 M272;
struct S284{Tid id;T0* _error_file;T0* _warning_file;T0* _message_file;};
extern T284 M284;
struct S47{Tid id;T2 _item;};
extern T47 M47;
struct S215{Tid id;T0* _container;T2 _position;T0* _next_cursor;};
extern T215 M215;
struct S327{Tid id;T0* _item;T0* _right;};
extern T327 M327;
struct S54{Tid id;T8 _item;};
extern T54 M54;
struct S347{Tid id;T0* _container;T2 _position;T0* _next_cursor;};
extern T347 M347;
...
struct S350{Tid id;};
extern T350 M350;
struct S288{Tid id;T0* _parameters;};
extern T288 M288;
struct S313{Tid id;T2 _count;T0* _first_cell;T0* _last_cell;T0* _internal_cursor;};
extern T313 M313;
struct S97{Tid id;T100 _basic_directory;};
extern T97 M97;
struct S300{Tid id;T6 _push_back_flag;T0* _path;T8 _input_stream;T2 _memory;T0* _name;T0* _last_string;};
extern T300 M300;
struct S190{Tid id;T0* _project;T0* _filename;T6 _reuse_variables;T0* _start_target_name;};
extern T190 M190;
struct S306{Tid id;T0* _item;};
extern T306 M306;
struct S148{Tid id;T0* _project;T0* _command_line;};
extern T148 M148;
struct S44{Tid id;T6 _item;};
extern T44 M44;
struct S333{Tid id;T2 _count;T2 _capacity;T0* _storage;T0* _FIXED_ARRAY_;};
extern T333 M333;
struct S113{Tid id;T115 _storage;T2 _capacity;T2 _upper;};
extern T113 M113;
struct S297{Tid id;T0* _path;T8 _output_stream;T0* _name;};
extern T297 M297;
...
extern T188 M188;
struct S235{Tid id;T0* _container;T2 _position;T0* _next_cursor;};
extern T235 M235;
struct S76{Tid id;T0* _children;T0* _attributes;T0* _name;T0* _content;};
extern T76 M76;
struct S302{Tid id;T0* _name;T100 _basic_directory;};
extern T302 M302;
struct S338{Tid id;};
extern T338 M338;
struct S337{Tid id;T2 _count;T2 _capacity;T0* _storage;T0* _FIXED_ARRAY_;T0* _internal_cursor;};
extern T337 M337;
struct S248{Tid id;};
extern T248 M248;
...
extern T181 M181;
struct S198{Tid id;T0* _project;T0* _name;T0* _value;};
extern T198 M198;
...
struct S104{Tid id;};
extern T104 M104;
struct S304{Tid id;T2 _last_code;T2 _next_pos;};
extern T304 M304;
struct S331{Tid id;T0* _uri;};
extern T331 M331;
struct S278{Tid id;T0* _content;T2 _capacity;T2 _position;T2 _column;T2 _line;T2 _index;T2 _upper;T6 _beginning_of_line;T6 _filled;T6 _interactive;T0* _file;T6 _end_of_file;};
extern T278 M278;
struct S289{Tid id;T0* _name;};
extern T289 M289;
struct S246{Tid id;};
extern T246 M246;
struct S293{Tid id;T0* _name;};
extern T293 M293;
...
struct S139{Tid id;};
extern T139 M139;
struct S285{Tid id;T115 _storage;T2 _capacity;T2 _upper;T2 _lower;};
extern T285 M285;
struct S202{Tid id;T204 _storage;T2 _capacity;T2 _upper;};
extern T202 M202;
struct S266{Tid id;T270 _storage;T2 _capacity;T2 _upper;};
extern T266 M266;
struct S200{Tid id;T2 _count;T2 _capacity;T0* _storage;T0* _FIXED_ARRAY_;T0* _internal_cursor;};
extern T200 M200;
struct S146{Tid id;T0* _project;T0* _esd_filename;T0* _clean;};
extern T146 M146;
...
extern T158 M158;
struct S220{Tid id;T0* _implementation;T0* _root_element;};
extern T220 M220;
struct S118{Tid id;};
extern T118 M118;
struct S280{Tid id;};
...
extern T103 M103;
struct S286{Tid id;T0* _program_name;};
extern T286 M286;
struct S242{Tid id;int _ef_event_fact;int _ep_event_fact;T0* _te_ep_tree_fact;T0* _te_ef_tree_fact;};
extern T242 M242;
...
extern T0*oBC198Value_attribute_name;
extern int fBC198Value_attribute_name;
...
extern T0*oBC251yytable_template;
extern int fBC251yytable_template;
...
extern T0*oBC252yy_ec_template;
extern int fBC252yy_ec_template;
T0* r250yy_ec_template(void);
void r250yy_execute_action(T250* C,T2 a1);
extern T0*oBC251yytranslate_template;
extern int fBC251yytranslate_template;
T0* r250yytranslate_template(void);
void r250clear_stacks(T250* C);
extern T0*oBC252yy_def_template;
extern int fBC252yy_def_template;
T0* r250yy_def_template(void);
void r250yy_load_input_buffer(T250* C);
extern T56 oBC251uc_collon;
extern int fBC251uc_collon;
T56 r250uc_collon(void);
extern T0*oBC251yyr1_template;
extern int fBC251yyr1_template;
T0* r250yyr1_template(void);
void r250make_with_buffer(T250* C,T0* a1);
T2 r250yy_null_trans_state(T250* C,T2 a1);
extern T0*oBC252yy_accept_template;
extern int fBC252yy_accept_template;
T0* r250yy_accept_template(void);
void r250read_token(T250* C);
extern T0*oBC251yyr2_template;
extern int fBC251yyr2_template;
T0* r250yyr2_template(void);
T2 r250yy_previous_state(T250* C);
extern T0*oBC251yypgoto_template;
extern int fBC251yypgoto_template;
T0* r250yypgoto_template(void);
void r250yy_refill_input_buffer(T250* C);
T0* r250yy_fixed_array(T0* a1);
extern T0*oBC252yy_meta_template;
extern int fBC252yy_meta_template;
T0* r250yy_meta_template(void);
extern T0*oBC252yy_base_template;
extern int fBC252yy_base_template;
...
extern T0*oBC252yy_nxt_template;
extern int fBC252yy_nxt_template;
...
extern T0*oBC251yydefact_template;
extern int fBC251yydefact_template;
T0* r250yydefact_template(void);
extern T0*oBC252yy_chk_template;
extern int fBC252yy_chk_template;
T0* r250yy_chk_template(void);
extern T0*oBC251yycheck_template;
extern int fBC251yycheck_template;
T0* r250yycheck_template(void);
void r250make(T250* C);
T0* r250yyfixed_array(T0* a1);
void r250yy_clear_all(T250* C);
extern T0*oBC251yydefgoto_template;
extern int fBC251yydefgoto_template;
T0* r250yydefgoto_template(void);
void r250yy_set_content(T250* C,T0* a1);
extern T0*oBC251yypact_template;
extern int fBC251yypact_template;
...
extern T0*oBC220stack;
extern int fBC220stack;
T0* r220stack(void);
...
extern T0*oBC271error;
extern int fBC271error;
T0* r271error(void);
void r271print_on(T271* C,T0* a1);
void r271out_in_tagged_out_memory(T271* C);
extern T0*oBC271input;
extern int fBC271input;
T0* r271input(void);
extern T0*oBC271output;
extern int fBC271output;
T0* r271output(void);
T0* r271twin(T271* C);
...
extern T7*ms143_420927692a;
extern T7*ms145_15065;
extern T7*ms288_1515383187;
extern T7*ms20_676;
extern T7*ms143_10a;
extern T7*ms20_691;
extern T7*ms158_82876;
extern T7*ms67_14150;
extern T7*ms145_347001;
extern T7*ms143_32a;
...
extern T7*ms304_336971577;
extern T7*ms20_3496;
extern T7*ms145_179802a;
extern T7*ms289_447851;
...
extern T7*ms147_10a;
extern T7*ms143_347001;
extern T7*ms147_2108796474;
...
extern T7*ms156_0;
extern T7*ms191_10;
extern T7*ms282_1158552108;
extern T7*ms145_5141265;
extern T7*ms157_0;
...
extern T7*ms145_2102912067a;
extern T7*ms189_2013612;
extern T7*ms255_195717202;

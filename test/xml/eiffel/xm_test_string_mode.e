...
feature {NONE} -- Test case
	...
	Ascii_content: STRING is "<doc>{</doc>"
	Utf8_latin1_content: STRING is "<doc>%/195/%/188/</doc>"
	Utf8_large_content: STRING is "<doc>%/196/%/137/</doc>"

	Ascii_char: CHARACTER is '{'
	Latin1_char: INTEGER is 252
	Large_char: INTEGER is 265
...
feature {NONE} -- Implementation
	...
	assert_content_string_static is
			-- Check output string is of type STRING.
		do
			assert_string_type (content.content, True)
		end
		
	assert_string_type (a_string: STRING; is_string: BOOLEAN) is

...
deferred class KL_TEST_UNIX_FILE_SYSTEM
...
feature -- Pathname handling
	...
	test_pathname_from is
		...
		do
			...
			assert_equal ("windows2", "/foo/bar", a_file_system.pathname_from ("c:\foo\bar", windows_file_system))
...
end -- class KL_TEST_UNIX_FILE_SYSTEM

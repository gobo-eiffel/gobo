...
feature -- Test
	...
	test_make_from_string is
		...
		do
			...
			!! uc_string.make_from_string ("bar")
	...
	test_is_integer is
		...
		do
			...
			!! uc_string.make_from_string ("4534")
	...
	test_is_hexadecimal is
		...
		do
			...
			!! uc_string.make_from_string ("45E34A")
	...
	test_substring_index is
		...
		do
			...
			!! uc_string1.make_from_string ("oba")
			...
			!! uc_string1.make_from_string ("foobar")
			uc_string1.put_code (432, 1)
	...
	test_concat is
		...
		do
			...
			!! uc_string1.make_from_string ("gobo")
			uc_string1.put_code (345, 2)
			!! uc_string2.make_from_string ("foogobo")
			...
			!! uc_string2.make_from_string ("gobofoo")
			...
			!! uc_string3.make_from_string ("foobar")
	...
	test_keep_head is
		...
		do
			...
			!! uc_string.make_from_string ("foobar")

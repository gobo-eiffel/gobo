indexing
	...
	description:
		...
		"Test features of class KL_WINDOWS_OUTPUT_FILE"
...
deferred class KL_TEST_WINDOWS_OUTPUT_FILE
		...
		do
			...
			if a_file.is_open_write then
				...
				if in_file.is_open_read then
					...
					assert_characters_equal ("carriage_return", '%R', in_file.last_character)
					in_file.read_character
					assert ("not_eof2", not in_file.end_of_file)

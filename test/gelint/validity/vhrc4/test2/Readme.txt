...
is of the Prefix form, but CC.f is a function with two arguments.
Validity VHRC-4 is violated.
----------------------------------------------------------------------
...
SmallEiffel -0.76:     PASSED     Reports that `f' is a procedure
                                  whereas it is actually a function
                                  with two arguments.
Halstenbach 3.2:       OK
gelint:                OK
----------------------------------------------------------------------

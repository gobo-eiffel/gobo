indexing
	...
	description:
		...
		"Test features of class INTEGER"
...
feature -- Test
	...
	test_set_item___fail_ise is
		...
		do
			...
			assert ("item3", (5).item = 5)
				...
				-- function.
			({INTEGER} 5 + {INTEGER} 6).set_item (-10)
			assert ("item4", ({INTEGER} 5 + {INTEGER} 6).item = 11)
		end
	...
	test_bit_and is
		...
		do
			...
			i1 := 5 --  00000000000000000000000000000101
			i2 := -5 -- 11111111111111111111111111111011
	...
	test_bit_or is
		...
		do
			...
			i1 := 5 --  00000000000000000000000000000101
			i2 := -5 -- 11111111111111111111111111111011
			i3 := -1 -- 11111111111111111111111111111111
	...
	test_bit_xor is
		...
		do
			...
			i1 := 5 --  00000000000000000000000000000101
			i2 := -5 -- 11111111111111111111111111111011
			i3 := -2 -- 11111111111111111111111111111110
	...
	test_bit_not is
		...
		do
			i1 := 5 --  00000000000000000000000000000101
			i2 := -6 -- 11111111111111111111111111111010
			assert ("bit_not1", i1.bit_not = i2)
			i1 := -2 -- 11111111111111111111111111111110
	...
	test_bit_shift_left is
		...
		do
			...
			i1 := -5 --  11111111111111111111111111111011
			i2 := -10 -- 11111111111111111111111111110110
			assert ("bit_shift_left2", i1.bit_shift_left (1) = i2)
			i1 := 2147483647 -- 01111111111111111111111111111111
			i2 := -2 --         11111111111111111111111111111110
	...
	test_bit_shift_right is
		...
		do
			...
			i1 := -5 -- 11111111111111111111111111111011
			i2 := -3 -- 11111111111111111111111111111101

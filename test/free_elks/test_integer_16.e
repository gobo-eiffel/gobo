indexing
	...
	description:
		...
		"Test features of class INTEGER_16"
...
feature -- Test
	...
	test_item is
		...
		do
			...
			assert ("item3", ({INTEGER_16} 25).item = 25)
			assert ("item4", ({INTEGER_16} -100).item = -100)
		end
	...
	test_set_item___fail_ise is
		...
		do
			...
			assert ("item3", (5).item = 5)
				...
				-- function.
			({INTEGER_16} 5 + {INTEGER_16} 6).set_item (-10)
			assert ("item4", ({INTEGER_16} 5 + {INTEGER_16} 6).item = 11)
		end
	...
	test_bit_not is
		...
		do
			i1 := 5 --  0000000000000101
			i2 := -6 -- 1111111111111010
			assert ("bit_not1", i1.bit_not = i2)
			i1 := -2 -- 11111111111111110

...
feature -- Test
	...
	test_all_default is
		...
		do
			create sp1.make (4)
			assert ("all_default1", sp1.all_default (0, 3))
			sp1.put (5, 2)
			assert ("not_all_default1", not sp1.all_default (0, 3))
			assert ("not_all_default2", not sp1.all_default (0, 2))
			assert ("all_default2", sp1.all_default (0, 1))
			assert ("all_default3", sp1.all_default (0, 0))
			create sp2.make (3)
			assert ("all_default3", sp2.all_default (0, 2))
			sp2.put ("gobo", 2)
			assert ("not_all_default3", not sp2.all_default (0, 2))
			assert ("all_default4", sp2.all_default (0, 1))
			assert ("all_default5", sp2.all_default (0, 0))
		end

indexing
	...
	description:
		...
		"Test features of class DS_SHELL_SORTER"
...
deferred class DS_TEST_SHELL_SORTER
...
feature -- Test
	...
	test_make is
		...
		local
			...
			a_sorter: DS_SHELL_SORTER [INTEGER]
		do
	...
	test_sort is
		...
		do
			...
			assert_iarrays_same ("items3", <<1, 2, 3, 4>>, a_list.to_array)
		end

indexing
	...
	description:
		...
		"Test features of class DS_BINARY_SEARCH_TREE_SET"
...
class DS_TEST_BINARY_SEARCH_TREE_SET
...
feature -- Test
	...
	test_binary_search_tree_set is
			-- Test features of DS_BINARY_SEARCH_TREE_SET.
		local
			l_set: DS_BINARY_SEARCH_TREE_SET [INTEGER]
	...
	test_binary_search_tree_set_cursor is
			-- Test the cursor implementation for binary search trees.
		local
			l_comparator: KL_COMPARABLE_COMPARATOR [INTEGER]
			l_tree: DS_BINARY_SEARCH_TREE_SET [INTEGER]
	...
	test_void is
		...
		local
			l_set: DS_BINARY_SEARCH_TREE_SET [STRING]
	...
	test_copy is
		...
		local
			l_comparator: KL_COMPARABLE_COMPARATOR [STRING]
			l_tree_1, l_tree_2: DS_BINARY_SEARCH_TREE_SET [STRING]
		do
			create l_comparator.make
	...
	test_set_operations
		...
		local
			l_comparator: KL_COMPARABLE_COMPARATOR [INTEGER]
			l_tree_1, l_tree_2, l_tree_3: DS_BINARY_SEARCH_TREE_SET [INTEGER]
		do
			create l_comparator.make
			create l_tree_1.make (l_comparator)
